...
public class ExcelTest {
    ...
    private static final List<Person> datas = new ArrayList<>(7);
    private static final List<String> titles = new ArrayList<>(7);

    private static final WriteData[] writedDatas = new WriteData[8];

    private static final int[][] coordinates = new int[8][];
    ...
    public static void before() {
        ...
        datas.add(new Person(-1, "李四lili", new Date(System.currentTimeMillis() - 1000L * 60L), 12345678901234L, 37.991, false, new BigDecimal("123.123123")));
        ...
        datas.add(new Person(79, "0" + Long.MAX_VALUE, new Date(System.currentTimeMillis() - 1000L * 6000L), 345678901234L, 2.000, true, new BigDecimal("23444.3123")));
    ...
    private void check(List<Person> list) {
        for (int i = 0; i < datas.size(); i++) {
            ...
            Assert.assertEquals(BigDecimal.valueOf(old.getScore()).setScale(2, BigDecimal.ROUND_HALF_UP).toString(), BigDecimal.valueOf(old.getScore()).setScale(2, BigDecimal.ROUND_HALF_UP).toString());
        }
    }
